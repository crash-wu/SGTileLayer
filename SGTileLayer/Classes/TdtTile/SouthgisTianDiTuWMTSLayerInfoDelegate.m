...
-(SouthgisTdt_LayerInfo*)getLayerInfo:(WMTSLayerTypes) tiandituType{
    ...
    if (tiandituType < 8) {//sr:webmecator
        ...
        layerInfo.lods = [NSMutableArray arrayWithObjects:
                          [[AGSLOD alloc] initWithLevel:0 resolution:0.7031249999891485 scale: 2.958293554545656E8],
                          [[AGSLOD alloc] initWithLevel:1 resolution:0.35156249999999994 scale: 1.479146777272828E8],
                          [[AGSLOD alloc] initWithLevel:2 resolution:0.17578124999999997 scale: 7.39573388636414E7],
                          [[AGSLOD alloc] initWithLevel:3 resolution:0.08789062500000014 scale: 3.69786694318207E7],
                          [[AGSLOD alloc] initWithLevel:4 resolution:0.04394531250000007 scale: 1.848933471591035E7],
                          [[AGSLOD alloc] initWithLevel:5 resolution:0.021972656250000007 scale: 9244667.357955175],
                          [[AGSLOD alloc] initWithLevel:6 resolution:0.01098632812500002 scale: 4622333.678977588],
                          [[AGSLOD alloc] initWithLevel:7 resolution:0.00549316406250001 scale: 2311166.839488794],
                          [[AGSLOD alloc] initWithLevel:8 resolution:0.0027465820312500017 scale: 1155583.419744397],
                          [[AGSLOD alloc] initWithLevel:9 resolution:0.0013732910156250009 scale: 577791.7098721985],
                          [[AGSLOD alloc] initWithLevel:10 resolution:0.000686645507812499 scale: 288895.85493609926],
                          [[AGSLOD alloc] initWithLevel:11 resolution:0.0003433227539062495 scale: 144447.92746804963],
                          [[AGSLOD alloc] initWithLevel:12 resolution:0.00017166137695312503 scale: 72223.96373402482],
                          [[AGSLOD alloc] initWithLevel:13 resolution:0.00008583068847656251 scale: 36111.98186701241],
                          [[AGSLOD alloc] initWithLevel:14 resolution:0.000042915344238281406 scale: 18055.990933506204],
                          [[AGSLOD alloc] initWithLevel:15 resolution:0.000021457672119140645 scale:9027.995466753102],
